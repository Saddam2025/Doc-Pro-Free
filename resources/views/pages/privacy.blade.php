...
<section class="py-16 bg-white text-center">
    <div class="container mx-auto px-6">
        ...
        <p class="text-lg text-gray-600 mb-6">
            If you have any questions about this Privacy Policy or how we protect your data, feel free to reach out to us. You can use the contact form below or click on the live chat button for immediate assistance.
        </p>
        
        <!-- Simple Contact Form -->
        <form action="{{ route('contact') }}" method="POST" class="max-w-2xl mx-auto">
            @csrf
            <div class="mb-4">
                <input type="text" name="name" class="w-full p-4 border border-gray-300 rounded-lg" placeholder="Your Name" required>
            </div>
            <div class="mb-4">
                <input type="email" name="email" class="w-full p-4 border border-gray-300 rounded-lg" placeholder="Your Email" required>
            </div>
            <div class="mb-4">
                <textarea name="message" class="w-full p-4 border border-gray-300 rounded-lg" placeholder="Your Message" rows="4" required></textarea>
            </div>
