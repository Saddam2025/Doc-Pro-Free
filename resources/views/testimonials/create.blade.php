...
@section('content')
<div class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex items-center justify-center py-12 px-6 sm:px-8">
    <div class="max-w-5xl w-full bg-white rounded-lg shadow-md p-6 lg:p-12">
